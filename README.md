...
The latest Memorandum to Government was submitted to the Cabinet on February 5th. No receipt —no acknowledgement; an *ipso facto* security lapse, and therefore a continuation of breach of duty discussed in the [Formal Complaint]() according to clear, audited legal substrates: see [Justiciable Omission](https://github.com/dr-wojak/start-here?tab=readme-ov-file#dealraitheachas-the-charters-and-the-architecture-of-justiciable-omission) and other [Legal Briefs](https://github.com/dr-wojak/legal).
